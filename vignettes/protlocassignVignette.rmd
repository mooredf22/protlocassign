...
This package implements a subcellular protein assignment procedure known as “constrained proportional assignment”, or CPA (Jadot et al, 2016). The basic concepts involved in CPA and analysis of subcellular proteomics data are described in the main paper (Moore et al., 2020). These tutorials serve as a basis for implementing CPA and various utilities for both experienced and beginner R users.
...
The companion supplementary tutorials may be installed as follows:
