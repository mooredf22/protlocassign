...
vignette: |
  %\VignetteIndexEntry{Using protlocassign for constrained 
...
by "protlocassign" is a similar fashion.
...
```
BiocManager::install("protlocassigndoc")
```
...
fractions constrained to 1.  This tutorial describes how 
...
As explained in the Tutorial 1, we will demonstrate using 
...
similar to the contents of this vignette. Tutorials 4 discusses using 
